...
1. **1. Crear Curso (POST)**: Haz clic en **Send**. Crea el curso y guarda el ID en `cursoId`.
...
### 3.3. CRUD de Estudiantes
Ve a la carpeta **"CRUD Estudiantes"**. **Nota:** Requiere que haya un `usuarioId` en las variables.
...
### 3.4. CRUD de Profesores
Ve a la carpeta **"CRUD Profesores"**. **Nota:** Requiere que haya un `usuarioId` en las variables.
...
### 3.5. CRUD de Asistencias
Ve a la carpeta **"CRUD Asistencias"**. **Nota:** Requiere que existan `estudianteId` y `cursoId`.
...
### 3.6. CRUD de Calificaciones
Ve a la carpeta **"CRUD Calificaciones"**. **Nota:** Requiere que existan `estudianteId` y `cursoId`.
...
4. **4. Actualizar Calificacion (PUT)**: Actualiza la nota.
5. **5. Eliminar Calificacion (DELETE)**: Elimina la calificación.
