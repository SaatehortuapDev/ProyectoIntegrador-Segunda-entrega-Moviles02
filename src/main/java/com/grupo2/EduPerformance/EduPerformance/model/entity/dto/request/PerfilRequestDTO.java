...
public class PerfilRequestDTO {
    ...
    // Validación básica de formato telefónico — solo dígitos, espacios y guiones
    @Pattern(regexp = "^[0-9\\s\\-\\+]{7,20}$", message = "El teléfono debe tener entre 7 y 20 dígitos")
    private String telefono;

    // Ambos campos son opcionales — el perfil puede completarse parcialmente
    // No incluimos 'usuario' — la relación se gestiona desde UsuarioService
